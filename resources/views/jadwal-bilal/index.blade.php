<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('jadwal-bilal.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Petugas Bilal</th>
                        ...
                        @forelse ($jadwal as $item)
                            <tr>
                                <td class="px-6 py-4 font-medium">
                                    <span class="px-2 py-1 text-xs rounded-full bg-cyan-100 text-cyan-800">
                                        {{ $item->label_pasaran }}
                                    </span>
                                </td>
                                <td class="px-6 py-4">
